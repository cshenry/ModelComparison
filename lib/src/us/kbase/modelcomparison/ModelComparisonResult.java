...
public class ModelComparisonResult {
    ...
    public ModelComparisonResult withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ModelComparisonResult withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ModelComparisonResult withCoreReactions(Long coreReactions) {
        this.coreReactions = coreReactions;
        return this;
    }
    ...
    public ModelComparisonResult withCoreCompounds(Long coreCompounds) {
        this.coreCompounds = coreCompounds;
        return this;
    }
    ...
    public ModelComparisonResult withCoreFamilies(Long coreFamilies) {
        this.coreFamilies = coreFamilies;
        return this;
    }
    ...
    public ModelComparisonResult withCoreBiomassCompounds(Long coreBiomassCompounds) {
        this.coreBiomassCompounds = coreBiomassCompounds;
        return this;
    }
    ...
    public ModelComparisonResult withProtcompRef(String protcompRef) {
        this.protcompRef = protcompRef;
        return this;
    }
    ...
    public ModelComparisonResult withPangenomeRef(String pangenomeRef) {
        this.pangenomeRef = pangenomeRef;
        return this;
    }
    ...
    public ModelComparisonResult withModels(List<ModelComparisonModel> models) {
        this.models = models;
        return this;
    }
    ...
    public ModelComparisonResult withReactions(List<ModelComparisonReaction> reactions) {
        this.reactions = reactions;
        return this;
    }
    ...
    public ModelComparisonResult withCompounds(List<ModelComparisonCompound> compounds) {
        this.compounds = compounds;
        return this;
    }
    ...
    public ModelComparisonResult withFamilies(List<ModelComparisonFamily> families) {
        this.families = families;
        return this;
    }
    ...
    public ModelComparisonResult withBiomasscpds(List<ModelComparisonBiomassCompound> biomasscpds) {
        this.biomasscpds = biomasscpds;
        return this;
    }
